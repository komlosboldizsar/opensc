...
namespace OpenSC.GUI.VTRs
{
    ...
    public partial class VtrList : ChildWindowWithTable
    {
        ...
        private static readonly EnumToBitmapConverter<VtrState> stateImageConverter = new EnumToBitmapConverter<VtrState>() {
            { VtrState.Stopped, Properties.Resources._16_vtr_stopped },
            { VtrState.Paused, Properties.Resources._16_vtr_paused },
            { VtrState.Playing, Properties.Resources._16_vtr_playing },
            { VtrState.Rewinding, Properties.Resources._16_vtr_rewinding },
