...
{
    public class MacroTriggerArgumentInt : MacroTriggerArgumentBase
    {

        private int? min;
        private int? max;

        public MacroTriggerArgumentInt(int? min = 0, int? max = null) : base(typeof(int), MacroArgumentKeyType.Integer)
        {
            this.min = min;
            this.max = max;
        }
