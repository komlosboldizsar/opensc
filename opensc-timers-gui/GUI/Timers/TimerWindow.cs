...
namespace OpenSC.GUI.Timers
{
    ...
    public partial class TimerWindow : ChildWindowBase
    {
        ...
        private static readonly Image MODE_IMAGE_BACKWARDS_ACTIVE = Icons.timer_backward;
        ...
        private static readonly Image RUNNING_STATE_IMAGE_STOPPED = Icons.timer_stopped;
        private static readonly Image RUNNING_STATE_IMAGE_PAUSED = Icons.timer_paused;
        private static readonly Image RUNNING_STATE_IMAGE_RUNNING = Icons.timer_running;
