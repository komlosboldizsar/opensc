...
namespace OpenSC.GUI.Routers
{
    ...
    public partial class RouterInputControl : RouterInputOutputControlBase
    {
        ...
        public RouterInputControl() => InitializeComponent();

        public RouterInputControl(RouterInput input, RouterControlForm containerForm) : this()
        {
            this.Input = input;
        ...
        private void button_Click(object sender, EventArgs e) => containerForm.InputClicked(this);
